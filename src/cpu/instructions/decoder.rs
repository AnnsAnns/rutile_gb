...
impl Instructions {
    ...
    fn read_byte_unprefixed(byte: u8) -> Option<Instructions> {
        ...
        match byte {
            ...
            0x08 => Some(Instructions::LD(LogicTargets::N16, LogicTargets::SP)),
            ...
            0xC7 => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xCF => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xD7 => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xDF => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xE7 => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xEF => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xF7 => Some(Instructions::RST(LogicTargets::N8)),
            ...
            0xFF => Some(Instructions::RST(LogicTargets::N8)),
            _ => None
        }
    }
}
